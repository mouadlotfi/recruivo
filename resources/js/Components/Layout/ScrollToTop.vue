...
<template>
    <button
        ...
        type="button"
        :class="[
            'fixed bottom-20 right-4 z-40 h-11 w-11 items-center justify-center rounded-full border border-amber-400/40 bg-white text-amber-600 shadow-xl shadow-stone-950/10 backdrop-blur transition hover:-translate-y-0.5 hover:bg-amber-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-50 dark:border-amber-500/40 dark:bg-stone-900/90 dark:text-amber-300 dark:shadow-stone-950/30 dark:hover:bg-stone-800 dark:focus-visible:ring-offset-stone-950 sm:bottom-6 sm:right-6',
            visible ? 'flex' : 'hidden',
        ]"

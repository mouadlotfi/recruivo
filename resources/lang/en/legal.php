    ...
    'privacy' => [
        ...
        'sections' => [
            ...
            [
                ...
                'body' => 'The cookies we set are the ones the site needs to work: a session cookie, a CSRF token cookie, cookies that remember your language and colour theme, and one recording that you have seen the cookie notice. We use no advertising or analytics cookies and we run no trackers. The fonts are served from this site rather than from a third party, so nothing you load here discloses your IP address to anyone else. The notice explains this; nothing on the site is waiting for your consent, because every cookie listed above is necessary for it to work. For statistics we run Umami on our own infrastructure. It sets no cookies and does not follow you across other sites: it records the page you viewed, the referrer, your browser and device type, and an approximate location derived from your IP address, which is not stored. Its script is served from this site, so nothing you load here reaches a third party. The site is delivered through Cloudflare, which necessarily sees the traffic it proxies.',
            ],
            [

...
return [
    ...
    'cookie_notice' => 'We use only the cookies needed to sign you in and remember your language and theme. Loading the web fonts from Google sends your IP address to Google, so we ask first.',

    ...
    'privacy' => [
        ...
        'sections' => [
            ...
            [
                ...
                'body' => 'Les cookies que nous déposons sont ceux dont le site a besoin pour fonctionner : un cookie de session, un jeton CSRF, des cookies mémorisant votre langue et votre thème, et un cookie indiquant que vous avez vu le bandeau d\'information. Nous n\'utilisons aucun cookie publicitaire ou de mesure d\'audience et aucun traceur tiers. Les polices sont servies par ce site et non par un tiers : rien de ce que vous chargez ici ne transmet votre adresse IP à quelqu\'un d\'autre. Le bandeau explique cela ; aucun élément du site n\'attend votre consentement, car tous les cookies ci-dessus sont nécessaires à son fonctionnement. Pour les statistiques, nous exploitons Umami sur notre propre infrastructure. Il ne dépose aucun cookie et ne vous suit pas d\'un site à l\'autre : il enregistre la page consultée, le référent, le type de navigateur et d\'appareil, ainsi qu\'une localisation approximative déduite de votre adresse IP, qui n\'est pas conservée. Son script est servi par ce site : rien de ce que vous chargez ici n\'atteint un tiers. Le site est diffusé via Cloudflare, qui voit nécessairement le trafic qu\'il relaie.',
            ],
            [

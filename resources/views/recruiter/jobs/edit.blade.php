...
<div class="space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-stone-900 dark:text-white">{{ __('recruiter.edit_job_title') }}</h1>
            <p class="mt-2 text-stone-600 dark:text-stone-400">{{ __('recruiter.edit_job_subtitle') }}</p>
        </div>
        <a 

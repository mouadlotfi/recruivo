...
>
    <button
        ...
        class="relative inline-flex h-11 w-11 items-center justify-center rounded-full text-stone-600 transition hover:bg-stone-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 dark:text-stone-200 dark:hover:bg-stone-800 dark:focus-visible:ring-offset-stone-950"
    >
        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
        </svg>
        @if($navbarUnreadCount > 0)
            <span class="absolute right-0.5 top-0.5 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-amber-600 px-1 text-[11px] font-bold leading-none text-white ring-2 ring-white dark:ring-stone-950" aria-hidden="true">
    ...
    <div
        ...
        class="fixed inset-x-3 top-[4.75rem] z-[10020] max-h-[min(32rem,calc(100vh-6rem))] overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-2xl sm:absolute sm:inset-x-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-[24rem] dark:border-stone-700 dark:bg-stone-900"
    >

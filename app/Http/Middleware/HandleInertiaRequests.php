...
class HandleInertiaRequests extends Middleware
{
    ...
    private const SHELL_TRANSLATION_SOURCES = [
        ...
        'popular_searches' => 'common.popular_searches',
        ...
        'terms_of_service' => 'common.terms_of_service',
        'legal_links' => 'common.legal_links',
        'cookie_notice' => 'common.cookie_notice',
        'cookie_accept' => 'common.cookie_accept',
        'cookie_necessary' => 'common.cookie_necessary',
        'cookie_settings' => 'common.cookie_settings',
        'open_sidebar' => 'common.open_sidebar',
        'close_sidebar' => 'common.close_sidebar',
        'done' => 'common.done',

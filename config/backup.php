...
return [
    ...
    'backup' => [
        ...
        /*
         * Master switch. The Demo environment turns this off: its database is
         * rebuilt nightly by demo:reset, so backing it up is waste.
         */
        ...
        'source' => [
            'files' => [
                ...
                'include' => array_values(array_filter([
                    // Only what the repository cannot reproduce: candidate resumes
                    // and company logos, plus the deployment env file. The file is
                    // mounted read-only because compose `env_file` injects variables
                    // and never places the file itself in the container. Paths that
                    // do not exist are dropped, so this still works outside Docker.
